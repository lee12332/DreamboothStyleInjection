...
message = {
    '00':{
        'pre':"a ",
        'post':" neon line as texture"
    },
    '01':{
        'pre':"a ",
        'post':" light oil painting depiction"
    },
    '02':{
        'pre':"a ",
        'post':" Made_of_Clay"
    ...
    '03':{
        'pre':"a ",
        'post':" with pencil drawing style"
    },
    '04':{
        'pre':"a ",
        'post':""
    ...
    '05':{
        'pre':"a ",
        'post':" slight chaotic curve background"
    },
    '06':{
        'pre':"a ",
        'post':" red frame, hollow out"
    },
    '07':{
        'pre':"a ",
        'post':" on the street"
    ...
    '09':{
        'pre':"a ",
        'post':" watercolor style"
    },
    '10':{
        'pre':"",
        'post':",Colorful background"
    },
    '11':{
        'pre':"",
        'post':",Solid color background"
    },
    '12':{
        'pre':"",
        'post':",made_of_lego"
    ...
    '16':{
        'pre':"",
        'post':",slight_pixel_art_depiction"
    },
    '17':{
        'pre':"",
        'post':",watercolor"
    ...
    '18':{
        'pre':"",
        'post':",Solid color background,Colored pencil painting"
    },
    '19':{
        'pre':"a ",
        'post':",made_of_little_blocks"
    },
    '20':{
        'pre':"a ",
        'post':",within_a_circular"
    },
    '21':{
        'pre':"a ",
        'post':",layered_paper_art_design"
    },
    '22':{
        'pre':"a ",
        'post':",color_lead_painting"
    },
    '23':{
        'pre':"a ",
        'post':",pen_drawing"
    ...
    '27':{
        'pre':"a ",
        'post':",bottom_is_lake,background_are_mountains"
    }
}
...
if __name__ == "__main__":
    ...
    lora_weights = "./ckpt/"
    generator = jt.set_global_seed(0)
    ...
    for i in range(min_num,max_num):
        ...
        for id, prompt in prompts.items():
            ...
            if int(id)/8 == sty_tag:
                ...
                # =============================================
            prompt_all = message[taskid]['pre']+prompt + f" in style_{taskid}"+message[taskid]['post']
            print(prompt_all)
            image = pipe(prompt_all, num_inference_steps=50, width=512, height=512,generator = generator).images[0]
